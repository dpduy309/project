...
?>
	...
	<?php $create_account_url = base_url('store_accounts/create'); ?>
						  ...
						  <tbody>
						  	<?php 
						  		...
						  		foreach($query->result() as $row){ 
						  			...
						  			$date_created = $this->timedate->get_nice_date($row->date_made,'datepicker');
						  	?>
							...
							<tr>
								...
								<td class="center">
									<a class="btn btn-success" href="<?= $view_account_url ?>">
