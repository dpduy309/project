					...
					<div class="box-content">
						...
						<form class="form-horizontal" method="POST" action="<?= $form_location ?>">
						  <fieldset>
							...
							<div class="control-group"> <label class="control-label" for="typeahead">Telnum</label> <div class="controls"> <input type="text" class="span6" name="telnum" value="<?= $telnum ?>" > </div> </div>
