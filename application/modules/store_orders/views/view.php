...
<p style="text-align: right">
	<a href="<?= base_url('invoices/test')?>">
		<button class="btn btn-success" type="">View InVoice</button>
	</a>
</p>
							  ...
							  <label class="control-label" for="typeahead">Order Status</label>
							   <div class="controls">
									<?php  
										...
										echo form_dropdown('order_status', $options, $order_status,$addition_dd_code);
					...
					<div class="box-content">
						<p style="text-align: right;">
							<a href="<?= base_url('store_accounts/create/'.$shopper_id)?>">
								<button type="button" class="btn btn-primary">Edit Account Details</button>
							</a>
						</p>
