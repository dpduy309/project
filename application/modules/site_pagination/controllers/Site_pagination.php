<?php 
	class Site_pagination extends MX_Controller
	{
		...
		public function _generate_pagination($data)
		{
			...
			$site_pagination = $this->pagination->create_links();
			return $site_pagination;
		}

		public function get_showing_statement($data)
		{
			//NOTE: to work, data should contain limit, offset, total_rows;
			...
			if($value2>$value3)
			{
				$value2 = $value3; // ngan nguoi dung nhap sai
			}
		...
		public function get_settings_for_public_bootstrap()
		{
