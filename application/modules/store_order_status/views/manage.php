...
?>
	...
	<?php $create_account_url = base_url('store_order_status/create'); ?>
	<p style="margin-top: 30px;">
	<a href="<?= $create_account_url ?>"><button type="button" class="btn btn-primary">Add New Order Status Options</button></a>
	</p>	
